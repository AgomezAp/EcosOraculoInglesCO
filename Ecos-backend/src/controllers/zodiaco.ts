    ...
    try {
      res.json({
        ...
        astrologer: {
          ...
          description:
            "Ancestral astrologer specialized in deciphering the mysteries of the cosmos and its influence on life",
          experience:
            "Decades interpreting the celestial codes of the universe",
          services: [
          ...
          approach:
            "Combines ancient Babylonian astrological wisdom with modern conversational approach to provide accessible celestial guidance",
        },
        timestamp: new Date().toISOString(),
      });
    } catch (error) {
