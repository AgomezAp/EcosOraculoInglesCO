...
- If you mention you're going to reveal something about the inner animal, ${
        shouldGiveFullResponse
...
Spiritual guide response (IN ENGLISH, ${
        isFirstMessage
      ...
      console.log(
        `✅ Inner animal reading generated (${
    ...
    try {
      res.json({
        ...
        guide: {
          ...
          specialty:
            "Communication with animal spirits and inner animal discovery",
          description:
