...
Love expert response (make sure to complete ALL your analysis before ending):`;
                ...
                console.log(`✅ Compatibility analysis generated successfully with ${usedModel} (${text.length} characters)`);
            ...
            try {
                res.json({
                    ...
                    loveExpert: {
                        ...
                        description: "Expert in love numerology specialized in analyzing compatibility between couples",
                        services: [
