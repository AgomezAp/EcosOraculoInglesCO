...
Astrologer response (make sure to complete ALL your astrological analysis before ending):`;
                ...
                console.log(`✅ Birth chart analysis generated successfully with ${usedModel} (${text.length} characters)`);
            ...
            try {
                res.json({
                    ...
                    astrologer: {
                        ...
                        description: "Astrologer specialized in creating and interpreting precise natal charts based on planetary positions at the moment of birth",
                        ...
                        approach: "Combines technical astrological precision with accessible spiritual interpretations to reveal your cosmic blueprint",
                    },
                    timestamp: new Date().toISOString(),
                });
            }
