...
Vocational counselor response (make sure to complete ALL your guidance before ending):`;
                ...
                console.log(`✅ Vocational guidance generated successfully with ${usedModel} (${text.length} characters)`);
            ...
            try {
                res.json({
                    ...
                    counselor: {
                        ...
                        specialty: "Professional guidance and personalized vocational mapping",
                        description: "Expert in vocational psychology with decades of experience helping people discover their true vocation",
                        services: [
                        ...
                        approach: "Evidence-based guidance combining personality assessment, interest evaluation, and labor market analysis to help individuals discover fulfilling career paths",
                    },
                    timestamp: new Date().toISOString(),
                });
            }
...
Remember: You are an expert guide who helps people discover their authentic vocation through a reflective, practical, and evidence-based process. Your goal is to empower, not decide for them. ALWAYS complete your guidance and suggestions.`;
    ...
    validateVocationalRequest(vocationalData, userMessage) {
        if (!vocationalData) {
            const error = new Error("Vocational counselor data required");
