...
- If you mention you're going to interpret something, ${shouldGiveFullResponse
...
Dream interpreter response (IN ENGLISH):`;
                console.log(`Generating dream interpretation (${shouldGiveFullResponse ? "COMPLETE" : "PARTIAL"})...`);
                let text = "";
                let usedModel = "";
                let allModelErrors = [];
                ...
                console.log(`✅ Interpretation generated (${shouldGiveFullResponse ? "COMPLETE" : "PARTIAL"}) with ${usedModel} (${finalResponse.length} characters)`);
...
Remember: You are a mystical but understandable guide, who ${isFullResponse
            ? "helps people understand the hidden messages in their dreams"
            : "intrigues about the profound mysteries that dreams hold"}. Always ${isFullResponse
